###########################################################################
## Makefile generated for component 'Final_V0_1'. 
## 
## Makefile     : Final_V0_1.mk
## Generated on : Thu Oct 13 15:38:21 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Final_V0_1.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Final_V0_1.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=100000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Final_V0_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_AnalogInput.o Final_V0_1.o Final_V0_1_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/Final_V0_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Final_V0_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Final_V0_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Final_V0_1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Final_V0_1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Final_V0_1.o : $(START_DIR)/Final_V0_1_ert_rtw/Final_V0_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Final_V0_1_data.o : $(START_DIR)/Final_V0_1_ert_rtw/Final_V0_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Final_V0_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"

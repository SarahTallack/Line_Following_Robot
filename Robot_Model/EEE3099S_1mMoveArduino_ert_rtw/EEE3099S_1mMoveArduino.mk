###########################################################################
## Makefile generated for component 'EEE3099S_1mMoveArduino'. 
## 
## Makefile     : EEE3099S_1mMoveArduino.mk
## Generated on : Tue Oct 04 14:03:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EEE3099S_1mMoveArduino.elf
...
PRODUCT_NAME              = EEE3099S_1mMoveArduino
MAKEFILE                  = EEE3099S_1mMoveArduino.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/sarah/Documents/EEE3099S/eee3099f-engineering-design-project/Robot_Model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/sarah/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~2
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EEE3099S_1mMoveArduino.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=10000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=EEE3099S_1mMoveArduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_ArduinoEncoder.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o EEE3099S_1mMoveArduino.o EEE3099S_1mMoveArduino_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
EEE3099S_1mMoveArduino.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/EEE3099S_1mMoveArduino.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EEE3099S_1mMoveArduino_data.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/EEE3099S_1mMoveArduino_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/EEE3099S_1mMoveArduino_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
